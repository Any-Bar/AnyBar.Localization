...
namespace AnyBar.Localization.Shared
{
    public static class Helper
    {
        ...
        public static bool GetAnyBarUseDependencyInjection(this AnalyzerConfigOptionsProvider configOptions)
        {
            if (!configOptions.GlobalOptions.TryGetValue("build_property.AnyBarUseDependencyInjection", out var result) ||
